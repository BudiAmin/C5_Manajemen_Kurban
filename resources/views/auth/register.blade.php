<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Alamat (NEW - using textarea instead of text-input component) -->
        <div class="mt-4">
        ...
        <!-- Hidden Role (NEW) - Default to 'peserta_kurban' for public registration -->
        <x-text-input type="hidden" name="role" value="peserta_kurban" />
